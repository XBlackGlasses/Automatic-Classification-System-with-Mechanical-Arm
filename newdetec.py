    ...
    while (True):  
        ...
        for i in range(len(boxes)):
            if i in indexes:
                ...
                depth = str(np.round(depth_frame.get_distance(int(x+w/2), int(y+h/2))*100, 4))  #取得 (x+w/2),(y+h/2)座標的深度
